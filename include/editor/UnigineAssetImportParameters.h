...
public:
	...
	/// <param name='compression'> <b>true</b> - to enabled lossy compression for the Heightmap Opacity data, <b>false</b> - to use lossless comression (Jackalless method).</param>
	...
	/// <param name='compression'> <b>true</b> - to enable lossy compression for the Albedo data, <b>false</b> - to use lossless comression (Jackalless method).</param>
	...
	/// <param name='compression'> <b>true</b> - to enable lossy compression for the Masks data, <b>false</b> - to use lossless comression (Jackalless method).</param>
	...
	/// <summary> Sets a new name for the the detail mask with the specified index. Mask names are synchronized with the current active <a href='https://developer.unigine.com/en/docs/latest/api/library/objects/landscape_terrain/class.objectlandscapeterrain'>ObjectLandscapeTerrain</a>.</summary>
	/// <param name='mask_index'> Index of the target detail mask.</param>
	...
	/// <summary> Returns the current name of the the detail mask with the specified index. Mask names are synchronized with the current active <a href='https://developer.unigine.com/en/docs/latest/api/library/objects/landscape_terrain/class.objectlandscapeterrain'>ObjectLandscapeTerrain</a>.</summary>
	/// <param name='mask_index'> Index of the target detail mask.</param>
