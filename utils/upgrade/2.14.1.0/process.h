...
namespace Process
{
	...
	*
	...
	void material(Material m)
	{
		...
		{
			m.removeParameter("inscatter_intensity");
			m.removeParameter("inscatter_density_threshold");
			m.removeParameter("inscatter_energy_compensation");
		}
	}
	...
	*
	...
	void node(Xml xml)
	{
		...
		{
			xml.removeChild("intersection_settings_bicubic");
			xml.removeChild("intersection_precision_begin");
			xml.removeChild("intersection_precision_end");
			xml.removeChild("bicubic_collision");
		}
	}
